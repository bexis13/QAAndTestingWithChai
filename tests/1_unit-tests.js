...
suite('Unit Tests', function(){
  ...
  suite('Equality', function() {
    ...
    test('#equal, #notEqual', function(){
      ...
      assert.equal( 6 * '2', '12', 'value calculated in multiplication, then coerced to string');
      assert.notEqual( 6 + '2', '12', 'the value is inserted into the string without evaluation' );
    });
